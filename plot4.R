# plot1.R
# reads in part of household_power_consumption.txt and generates a histogram and 3 plots
# of the variables Global_active_power, Sub_metering_1, Sub_metering_2, Sub_metering_3, 
# Voltage, and Global_reactive_power by time.
...
# Create the histogram and plots as a png file in the current working directory

png(file = "plot4.png")
par(mfrow = c(2, 2))
with(pData, plot(datetime, global_active_power, type = "l", xlab = "", ylab = "Global Active Power (kilowatts)"))
with(pData, plot(datetime, voltage, type = "l", ylab = "Voltage"))
