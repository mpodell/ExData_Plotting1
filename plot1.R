# plot1.R
# reads in part of household_power_consumption.txt and generates a histogram of the variable Global_active_power
...
# Create the histogram as a png file in the current working directory
